...
{
	private PointF	mDimensions = new PointF(); // INCLUIR NO TEXTO!!!!
	...
	{			
		...
		mDimensions.x = mDrawingArea.right - mDrawingArea.left;
		mDimensions.y = mDrawingArea.bottom - mDrawingArea.top;
	}
